    ...
    <Grid
      ...
      <Grid item xs={12}>
        <Grid container spacing={3}>
         ...
         <Grid item xs={12} md={8} lg={10}>
            {/*selectedOffice === "Ludhiana" && (*/}
            <iframe
              src="YOUR_GOOGLE_MAPS_LINK_FOR_LUDHIANA"
              width="100%"
              height="450"
              style={{border: "0px"}}
              allowfullscreen=""
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="Ludhiana Office"></iframe>
            {/* )} */}
       </Grid>
      </Grid>
    </Grid>
  {selectedOffice === "Panipat" && (
    <iframe
      src="YOUR_GOOGLE_MAPS_LINK_FOR_PANIPAT"
      width="100%"
      height="450"
      style={{border: "0px"}}
      allowfullscreen=""
    ...
    ></iframe>
      ...
      <Grid item xs={12} md={6} mt="20px">
        <Typography
          ...
          fontWeight="600"
          fontSize={"32px"}>
          Catalyze your inquiry
          <br />
          And we will reach out to you within minutes👋
        </Typography>
        <Formik
          initialValues={{
            firstName: "",
